...
/**
 * Webservice helper class containing functions for the outcome instance data type.
 *
...
class outcome_instance extends outcome {

    /**
     * Internal function defining a outcome instance structure for use in "_returns" definitions.
     *
